...
function AccountScreen({ navigation }) {
  ...
  const [currentPassword, setCurrentPassword] = React.useState(global.password);
  ...
  ChangeRecord = () => {
    ...
    if (newPassword.length == 0) {
      Alert.alert(
        ...
        "New password cannot be blank."[{ text: "Ok" }]
      );
    } else {
      {
        var SearchAPIURL =
    ...
    <View style={styles.parentContainer}>
      <View style={styles.list}>
        <Text style={styles.textStyle}>
          {" "}
          Password: <Text style={styles.infoStyle}>{currentPassword}</Text>
        </Text>
        <Pressable
      ...
      <View style={styles.list}>
        <Text style={styles.textStyle}>
          {" "}
          Email: <Text style={styles.infoStyle}>{email}</Text>
        </Text>
        {/* <Pressable
                style={[styles.resetButton]}
